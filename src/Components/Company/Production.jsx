  ...
  return (
    <div>
      ...
      <div className="flex items-center lg:flex-col sm:items-start lg:gap-10 gap-40">
        <div data-aos="zoom-in" className="w-[700px] lg:h-[700px] sm:w-[420px] sm:h-[420px] sm:pl-1 h-[700px]">
        ...
        <div data-aos="zoom-in" className="w-[581px]  sm:w-[340px] sm:h-[1300px] h-[800px] flex flex-col justify-center  lg:justify-start  lg:pl-10 ">
          <p className="font-[300]   text-[20px] lg:text-[20px] leading-[40px] sm:leading-[35px] tracking-[0.1px] lg:tracking-normal text-[#363637]">
          ...
          <p className="font-[300] sm:tracking-normal lg:text-[20px] text-[20px] leading-[40px] sm:leading-[35px] mt-10 tracking-[0.1px] text-[#363637]">Our operatives are able to communicate in the
