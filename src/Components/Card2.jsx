  ...
  return (
    <div  className="w-[100%]">
        ...
        <div className="flex flex-row-reverse lg:flex-col lg:items-start items-center gap-32">
            <div data-aos="zoom-in" data-aos-duration="800" data-aos-delay="200" className="w-[729px] sm:w-[400px] sm:h-[400px] h-[729px] relative lg:left-0 sm:left-2 xsm:left-0 right-[-50px] sm:cardImageCenter z-[10]"><img src={Image} alt="" /></div>
